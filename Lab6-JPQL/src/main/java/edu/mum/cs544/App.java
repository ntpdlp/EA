...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TypedQuery<Airline> q2 = em.createQuery("select distinct ar from Airline ar JOIN ar.flights f where f.airplane.model =:model",Airline.class);
        q2.setParameter("model","A380");
        List<Airline> airlines = q2.getResultList();
        ...
        TypedQuery<Flight> q3 = em.createQuery("from Flight f where f.airline.name != :name and f.airplane.model = :model", Flight.class);
        q3.setParameter("name", "Star Alliance");
        q3.setParameter("model", "747");
        flights = q3.getResultList();
